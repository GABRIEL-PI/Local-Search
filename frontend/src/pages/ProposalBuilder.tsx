      ...
      <div className="grid grid-cols-2 gap-4">
        <Card>
          <CardContent className="p-4">
            <p className="text-xs text-gray-500 mb-1">Valor de Setup</p>
            <input
              type="number"
              value={edits.preco_sugerido || ''}
              onChange={(e) => setEdits({ ...edits, preco_sugerido: Number(e.target.value) })}
              className="w-full text-2xl font-bold text-gray-900 border-b border-gray-200 focus:outline-none focus:border-blue-500 pb-1"
            />
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            ...
            <input
              ...
              className="w-full text-2xl font-bold text-green-600 border-b border-gray-200 focus:outline-none focus:border-blue-500 pb-1"
            />
          </CardContent>
        </Card>
      </div>
