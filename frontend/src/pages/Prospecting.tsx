  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Encontre novos leads no Google Maps</p>
      </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="flex gap-2">
                  <div className="flex-1">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="pl-9 pr-3 py-2 text-sm border border-gray-300 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required
                      />
                    </div>
                  </div>
                  <div className="w-20">
                    ...
                    <input
                      ...
                      placeholder="SP"
                      maxLength={2}
                      className="px-3 py-2 text-sm border border-gray-300 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-blue-500 uppercase"
                    />
                  </div>
                </div>
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-600 mb-1">
                    Limite de leads: <span className="font-bold text-blue-600">{form.limite}</span>
                  </label>
                  <input
                    type="range"
                    min={10}
            ...
            <CardContent>
              {sessions.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">Nenhuma sessão iniciada ainda</p>
                  <p className="text-xs text-gray-400 mt-1">Inicie sua primeira prospecção</p>
                </div>
              ) : (
                    ...
                    return (
                      ...
                      >
                        <div className="w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center flex-shrink-0">
                          <Icon className={`w-5 h-5 text-blue-600 ${session.status === 'rodando' ? 'animate-spin' : ''}`} />
                        </div>
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            <p className="text-sm font-medium text-gray-900">{session.categoria}</p>
                        ...
                        <div className="text-right flex-shrink-0">
                          <p className="text-lg font-bold text-gray-900">{session.leads_salvos}</p>
                          <p className="text-xs text-gray-400">salvos</p>
                          <p className="text-xs text-gray-300">{session.leads_encontrados} encontrados</p>
                        </div>
                      </div>
                    )
                  })}
