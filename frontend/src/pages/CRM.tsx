  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-fg">CRM Kanban</h1>
      ...
      {loading && leads.length === 0 ? (
        <div className="flex items-center justify-center py-24">
          ...
          <span className="ml-2 text-fg-subtle">Carregando leads...</span>
        </div>
      ) : leads.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-24 text-center">
          <Kanban className="w-16 h-16 text-fg-faint mb-4" />
          <h2 className="text-xl font-semibold text-fg">Nenhum lead encontrado</h2>
          <p className="text-fg-faint mt-2">Ajuste os filtros ou inicie uma nova prospecção</p>
        </div>
      ) : (
