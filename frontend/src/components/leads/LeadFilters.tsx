...
export default function LeadFilters({ onFilter, loading }: LeadFiltersProps) {
  ...
  return (
    <div className="bg-surface rounded-xl border border-border p-4">
      <div className="flex items-center gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="pl-9 pr-4 py-2 text-sm border border-border-strong rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
        <Button
          variant="outline"
      ...
      {expanded && (
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-border">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-1.5 text-sm border border-border-strong rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          <div>
          ...
          <div>
            <label className="block text-xs font-medium text-fg-muted mb-1">Score mínimo</label>
            <input
              type="number"
              placeholder="0"
              min="0"
