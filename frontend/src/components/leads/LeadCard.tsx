    ...
    <Card className="hover:shadow-md transition-shadow">
      <CardContent className="p-4">
        ...
        <div className="flex flex-wrap gap-1.5 mb-3">
          {!lead.tem_site && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-red-50 text-red-600 text-xs rounded-full font-medium">
              <Globe className="w-3 h-3" />
              Sem site
            </span>
          )}
          {lead.whatsapp && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-green-50 text-green-600 text-xs rounded-full font-medium">
